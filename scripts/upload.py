...
player_valuations_df = pd.read_csv('../data/clean/player_valuations.csv')
player_valuations_df.to_sql('player_valuations', connection, if_exists='replace')

players_df = pd.read_csv('../data/clean/players.csv')
players_df.to_sql('players', connection, if_exists='replace')

transfers_df = pd.read_csv('../data/clean/transfers.csv')
